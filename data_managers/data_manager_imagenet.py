...
class tinyImageNet(object):
    def download_data(self):
        train_dir = os.path.join('../seed_1993_subset_100_imagenet', 'data', 'train')
        test_dir = os.path.join('../seed_1993_subset_100_imagenet', 'data', 'val')
...
class DataManagerImagenet(object):
    def __init__(self, shuffle, seed):
        self._setup_data(shuffle=shuffle, seed=seed)
